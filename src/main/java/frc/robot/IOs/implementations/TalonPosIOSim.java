 ...
 */
public class TalonPosIOSim extends TalonPosIORobot {
     ...
     */
    public TalonPosIOSim(int id, String canbus, double gearRatio, Slot0Configs config, MotionMagicConfigs mmConfigs, boolean inverted) {
        super(id, canbus, gearRatio, config, mmConfigs, inverted);
